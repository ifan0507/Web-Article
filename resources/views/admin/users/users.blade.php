        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <div class="flash-user" data-flash-user="{{ session('status') }}"></div>
                            ...
                            @foreach ($user as $users)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <th scope="row"
                                        ...
                                        {{ $users->name }}</th>
                                    <td class="px-4 py-3">{{ $users->username }}</td>
                                    <td class="px-4 py-3">{{ $users->email }}</td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <a href="/edit-user/{{ $users->name }}">
                                        ...
                                        <form action="{{ route('user.delete', ['id' => $users->id]) }}"
                                            method="post">
                                            @method('delete')
                                            @csrf
                                            <button type="submit" class="hapus-user">
                                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    fill="none" viewBox="0 0 24 24">
                                                    <path stroke="currentColor" stroke-linecap="round"
