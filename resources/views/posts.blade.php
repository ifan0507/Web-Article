            ...
            @forelse ($posts as $post)
                <article
                    ...
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        ...
                        {{-- untuk format waktu berapa waktu yang lalu menggunakan $post->created_at->diffForHumans() --}}
            ...
            @empty
                <div>
                    <p class="font-semibold text-xl my-4">
                        No posts found. Please check your search criteria or try a different search.
                    </p>
                    <a href="/posts" class="block text-blue-600 hover:underline">&laquo; Back to all post
                    </a>
                </div>
            @endforelse
        </div>
